#!/usr/bin/env python3
"""
Fetch Training Data from Variant Nowcast Hub for BART Model
=============================================================================

This script fetches the latest time-series data from the variant nowcast hub
for a specified nowcast date. The data is used to train the PyMC BART model.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Fetch training data from variant nowcast hub for BART model"
    )
    parser.add_argument(
        "--nowcast-date",
        type=str,
